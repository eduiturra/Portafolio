<%@ Page Language="C#" MasterPageFile="~/1-EnfermeraAgenda/Enfermera.Master" AutoEventWireup="true" CodeBehind="Registrar.aspx.cs" Inherits="WebApplication1.Registrar"
            ...
            <div class="form-group">
                <label for="ejemplo_email_1">
                    Pabellon</label>&nbsp;<asp:DropDownList ID="cboPabellon" runat="server" Enabled="False"
                        ...
                        <asp:ListItem>1 c.m</asp:ListItem>
                    </asp:DropDownList>
            </div>
            <div class="form-group">
                <label for="ejemplo_email_1">
