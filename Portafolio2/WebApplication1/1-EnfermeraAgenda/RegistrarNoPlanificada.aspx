<%@ Page Title="" Language="C#" MasterPageFile="~/1-EnfermeraAgenda/Enfermera.Master" AutoEventWireup="true" CodeBehind="RegistrarNoPlanificada.aspx.cs" Inherits="WebApplication1.RegistrarNoPlanificada" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div  class="col-md-6">
         <h2>Agendar Cirugía No Planificada</h2>
        ...
        <div class="form-group">
                <label for="ejemplo_email_1">
                    Aseo</label>(*)
                <asp:DropDownList ID="cboAseo" runat="server" CssClass="form-control input-sm"
                     Enabled="False" onselectedindexchanged="cboAseo_SelectedIndexChanged">
            ...
            <asp:Button ID="btnGuardar" CssClass="btn btn-default" runat="server" OnClick="btnGuardar_Click"
